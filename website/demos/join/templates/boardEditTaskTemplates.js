function getEditTaskDialogTemplate(task) {return `
    ...
    `;}function getEditTaskFieldsTemplate(task) {return `
    ...
    `;}function getEditTaskPriorityTemplate(priorities) {return `
        <div class="dialog-field-group">
    ...
    `;}function getEditPriorityOptionTemplate(priority) {return `
    ...
    `;}function getEditTaskAssignedTemplate() {return `
    ...
    `;}function getEditTaskSubtasksTemplate() {return `
        <div class="dialog-field-group">
